...
# 2. Listar registros
curl -H "Authorization: Bearer $TOKEN" http://localhost:8080/api/empresas
...
|----------|---------|---------|
| `/api/empresas` | GET / POST / PUT / DELETE | CRUD de Empresa |
| `/api/vagas` | GET / POST / PUT / DELETE | CRUD de Vaga |
| `/api/candidatos` | GET / POST / PUT / DELETE | CRUD de Candidato |
| `/api/candidaturas` | GET / POST / PUT / DELETE | CRUD de Candidatura |
